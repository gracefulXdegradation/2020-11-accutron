          ...
          <Column w="100%" h="100%">
            <Layer ref={img1Ref}>
              <Column w="100%" h="100%" align="center" justify="center">
                <Watches ref={img1Ref} src={CollectionWatches1} alt="Collection Watches 1" />
              </Column>
            </Layer>
            <Layer ref={img2Ref} css={css`opacity: 0;`}>
              <Column w="100%" h="100%" align="center" justify="center">
                <Watches ref={img1Ref} src={CollectionWatches2} alt="Collection Watches 2" />
              </Column>
            </Layer>
            <Layer ref={img3Ref} css={css`opacity: 0;`}>
              <Column w="100%" h="100%" align="center" justify="center">
                <Watches ref={img1Ref} src={CollectionWatches3} alt="Collection Watches 3" />
              </Column>
            </Layer>
            <Layer ref={img4Ref} css={css`opacity: 0;`}>
              <Column w="100%" h="100%" align="center" justify="center">
                <Watches ref={img1Ref} src={CollectionWatches3} alt="Collection Watches 7" />
              </Column>
            </Layer>
          </Column>
        </Slide>
